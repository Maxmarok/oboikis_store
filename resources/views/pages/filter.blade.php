...
<div class="catalog_filter_block w-auto">
    <div class="bc_block m-auto w-100">
        <div class="breadcrumbs mb-5 ms-auto me-auto mt-5">
            ...
            <span class="blue_color c_t1_span3"><a href="#">Каталог</a></span>
            <span class="pink_color c_t1_span2 align-items-end"> — Обои</span>
        </div>
    </div>
    <div class="catalog_filter_screen me-auto ms-auto d-flex align-items-start justify-content-between flex-column">
        <div class="mb-5 bread">
            ...
            <span class="catalog_filter_text3 pink_color">— Обои</span>
        </div>
                        ...
                        <div class="col">
                            <div class="screen3_block d-flex flex-column p-auto position-relative s3_b_pink">
                                ...
                                <div class="s3_b1_text d-flex flex-row justify-content-around align-items-center w-100 pink_color bg_pink2">
                                    ...
                                    <div><span class="s3_b_text1">Россия, 10.05 x 1.06 м <p class="text-end">Флизелин, Винил</span></div>
                                </div>
                                ...
                                <div class="s3_b_footer_pink d-flex flex-row justify-content-around align-items-center">
                                    ...
                                    <button class="d-flex pink_color flex-row align-items-center justify-content-evenly">Купить<img src="svg/pinkcart.svg"></button>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="screen3_block d-flex flex-column p-auto s3_b_blue">
                                ...
                                <div class="s3_b_text d-flex flex-row justify-content-around align-items-center w-100">
                                    ...
                                    <div class="blue_color"><span class="s3_b_text1">Россия, 10.05 x 1.06 м <p class="text-end">Флизелин, Винил</span></div>
                                </div>
                                ...
                                <div class="s3_b_footer_blue d-flex flex-row justify-content-around align-items-center">
                                    ...
                                    <button class="d-flex blue_color flex-row align-items-center justify-content-evenly">Купить<img src="svg/bluecart.svg"></button>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="screen3_block d-flex flex-column p-auto position-relative s3_b_orange">
                                ...
                                <div class="s3_b1_text d-flex flex-row justify-content-around align-items-center w-100 orange_color bg_orange2">
                                    <div class="s3_b_text0 d-flex align-items-center justify-content-center"><span>11 рулонов</span></div>
                                    <div class="orange_color"><span class="s3_b_text1">Россия, 10.05 x 1.06 м <p class="text-end">Флизелин, Винил</span></div>
                                </div>
                                ...
                                <div class="s3_b_footer_orange d-flex flex-row justify-content-around align-items-center">
                                    ...
                                    <button class="d-flex orange_color flex-row align-items-center justify-content-evenly">Купить<img src="svg/orangecart.svg"></button>
                                </div>
                            </div>
                        </div>
                        <div class="col">
...
<div class="m_cards display-none ">
    <div class="screen3_block d-flex flex-column p-auto s3_b_blue">
        <div class="s3_b_img"><img src="img/image 4.png"></div>
        <div class="s3_b_text d-flex flex-row justify-content-around align-items-center w-100">
            <div class="s3_b_text0 d-flex align-items-center justify-content-center gray_color"><span>На заказ</span></div>
